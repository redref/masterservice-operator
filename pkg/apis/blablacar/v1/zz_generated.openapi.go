...
func schema_pkg_apis_blablacar_v1_MasterService(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MasterService is the Schema for the masterservices API",
...
func schema_pkg_apis_blablacar_v1_MasterServiceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MasterServiceSpec defines the desired state of MasterService",
				Properties:  map[string]spec.Schema{},
			},
		},
		Dependencies: []string{},
...
func schema_pkg_apis_blablacar_v1_MasterServiceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MasterServiceStatus defines the observed state of MasterService",
				Properties:  map[string]spec.Schema{},
			},
		},
		Dependencies: []string{},
